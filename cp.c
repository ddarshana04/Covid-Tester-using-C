...
int f,c,h;
   ...
   printf("  \n\033[0;30m what is your test results?? (P/N):");
   scanf("%c",&result);
   scanf("%c",&result);
     ...
     if(result == 'P' || result == 'p'){
       ...
       printf("\n\nCheck your temperature!!");
        ...
        int temp; 
        printf("\n\n \033[0;30m  Enter temperature value:");
        scanf("%d",&temp);
        if(temp>=100){
         printf("\033[0;31m𝗧 𝗔 𝗞 𝗘   𝗕 𝗟 𝗢 𝗢 𝗗   𝗧  𝗘 𝗦 𝗧");
            char answer1[12] ;
float cbc,crp,d;
    printf("\n \033[0;30m  enter your CBC value:");
          scanf("%f",&cbc);
        printf(" \033[0;30m  enter your CRP value:");
           scanf("%f",&crp);
         printf("\033[0;30m  enter your D -dimer value: ");
           scanf("%f",&d);
         printf(" \033[0;30m  enter LDH (normal or above normal):");
           scanf("%s",&answer1);
    ...
    printf("\n\n\n Post 48 hours!! \n        DAY 7 \n  (Repeat CBC, CRP, D-Dimer, LDH)");
        ...
        printf("\n\n \033[0;30m Enter your oxygen level:");
        scanf("%d",&pulse_oxygen);
        
        
           char b_report= '0';
           // H/h=high & L/l= low
           printf(" \033[0;30m What was your blood report?? (H/L): ");
           scanf("%c", &b_report);
           scanf("%c", &b_report);
